      ...
      <div>
        {error && (
          <div
            className={`${
              darkTheme ? "dark" : ""
            } errorMessage d-flex flex-column justify-content-center align-items-center`}
          >
    ...
    return (
      <div>
        <div className={`d-flex justify-content-between align-items-center`}>
          ...
          <div>
            <span
              className={`playButton d-flex mb-4 justify-content-center align-items-center ${
                darkTheme ? "dark" : ""
              }`}
            >
              <MdPlayArrow
        ...
        >
          ...
          <div
            className={`bottomLink d-flex gap-2 align-items-center ${
              darkTheme ? "dark" : ""
            }`}
          >
            <p>{sourceUrl}</p>
